...
$.widget("ui.panel", {
	...
	_create: function() {
		...
		this.headers.each(function(i,e){
			...
			/*
			*  Add for the Kawwa2 project
			*  Need to display by default the content of a panel
			*/
            self.setExpandedByDefault(pHeader);
		});
		this._createIcons();
	},
	setExpandedByDefault: function(header){
          var content = header.next();
          content.addClass("ui-panel-content ui-helper-reset ui-widget-content ui-corner-bottom");
          if(header.hasClass("ui-state-active")) content.show(); else content.hide();
        },
