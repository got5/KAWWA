requirejs.config({
	"shim" : {
		...
		"kawwa/vendor/superfish": ["kawwa/vendor/jquery-migrate"]
	}
});
define(["kawwa/vendor/superfish"], function() {
	init = function(spec) {
	    jQuery("#" + spec.id+" > li > div, #" + spec.id+" > li > ul").addClass("dropdown");
        	
            var theMenu = jQuery("#" + spec.id).addClass("k-navbar");
