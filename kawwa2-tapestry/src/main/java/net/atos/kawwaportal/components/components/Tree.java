...
public class Tree
{
	...
	@Inject @Symbol(value=JQuerySymbolConstants.SUPPRESS_PROTOTYPE) private boolean prototype;
    /**
    ...
    public void setupRender(){
    	...
    	if(prototype) path="/net/atos/kawwaportal/components/assets/tree/tree-jquery.js";
