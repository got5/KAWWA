...
public class Kawwa2Pager {
	...
	protected void writePageLink(MarkupWriter writer, int pageIndex) {
		...
		writer.element("a", "href", link, "title", String.format(KawwaUtils.getMessages("goto-page", kawwaMessages, null), pageIndex), "class", "a" + pageIndex);
	...
	protected void imageOn(MarkupWriter writer, int index, String title,
		...
		Link link = resources.createEventLink(EventConstants.ACTION, index);
		writer.element("a", "href", link, "class", id, "title", title);
