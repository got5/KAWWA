...
public class ArticleOrganizer {
	...
	public String getCurrentArticleImageURL() {
		...
		if(currentArticle.getImage() == null && messages.contains(currentArticle.getCategory()))
			currentImageURL = assetsource.getClasspathAsset(messages.get(currentArticle.getCategory())).toClientURL();
		else
			currentImageURL = currentArticle.getImage().toClientURL();
	...
	public String getCurrentArticleAltenative() {
		...
		if(messages.contains(currentArticle.getRef()))
			...
			currentAlternative = currentArticle.getRef();
