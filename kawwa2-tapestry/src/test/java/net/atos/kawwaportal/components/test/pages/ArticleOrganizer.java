...
public class ArticleOrganizer {
	...
	public List<TabArticleDetail> generateInitialData() {
		...
		Article11.setImage(assetsource.getClasspathAsset("/net/atos/kawwaportal/components/theme/img/k-theme1/bt_prev.png"));
		...
		Article12.setImage(assetsource.getClasspathAsset("/net/atos/kawwaportal/components/theme/img/k-theme1/bt_prev_off.png"));
		...
		Article21.setImage(assetsource.getClasspathAsset("/net/atos/kawwaportal/components/theme/img/k-theme1/bt_next.png"));
		...
		Article22.setImage(assetsource.getClasspathAsset("/net/atos/kawwaportal/components/theme/img/k-theme1/bt_next_off.png"));
