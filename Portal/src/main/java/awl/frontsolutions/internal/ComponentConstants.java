...
public class ComponentConstants {
	...
	public static final String FILE_INDEXER_ROOT = "awl.filesystemindexer.root";
    public static final String METADATA_FILE_NAME = "metadata.properties";
    public static final String DOC_INFO_FILE = "info.properties";
    public static final String METADATA_NAME_KEY = "name";
    public static final String METADATA_TYPE_KEY = "type";
    public static final String METADATA_URL_PARAM = "urlParam";
    public static final String METADATA_TAG = "tags";
    public static final String METADATA_CSS = "css";
	...
	public static final String SNIPPET_JS = "snippet.js";
	public static final String SNIPPET_CSS = "snippet.css";
	public static final String SNIPPET_CSS3 = "snippet.css3";
	public static final String SNIPPET_HTML = "snippet.html";
	...
	public static final String READMORE_CSS = "readmore.css";
	public static final String READMORE_CSS3 = "readmore.css5";
