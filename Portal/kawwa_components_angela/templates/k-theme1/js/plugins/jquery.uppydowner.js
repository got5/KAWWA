...
{	
	$.fn.uppydowner = function (settings) {
		...
		this.each(function (index) {
			...
			var down = "<span role=\"button\" title=\"One product less\" id=\"" + config.classModifier + index + "_down\" class=\"" + config.classModifier + "button down\">" + config.downButton + "</span>";
			var up = "<span role=\"button\" title=\"One product more\" id=\"" + config.classModifier + index + "_up\" class=\"" + config.classModifier + "button up\">" + config.upButton + "</span>";
